...
for ((iter1=0; iter1<1; iter1++)){
	for((iter2=0; iter2<=2; iter2++)){
		...
		do
			...
			./fio --group_reporting --name=test --directory=/mnt/sd"$x" --size="$SIZE"GB --bs="$BS"KB --direct="$DIRECT" --fsync=0 --rw=write --numjobs="$njobs" >> ./result_sd"$x"_buffered.txt 2>&1 & 
		done
		wait
	}
	let BS=$BS*2;
...
for ((iter1=0; iter1<1; iter1++)){
	for((iter2=0; iter2<2; iter2++)){
		...
		do
			...
			./fio --group_reporting --name=test --directory=/mnt/sd"$x" --size="$SIZE"GB --bs="$BS"KB --direct="$DIRECT" --fsync=0 --rw=read --numjobs="$njobs" >> ./result_sd"$x"_buffered.txt 2>&1 & 
		done
		wait
	}
	let BS=$BS*2;
...
for ((iter1=0; iter1<1; iter1++)){
	for((iter2=0; iter2<2; iter2++)){
		...
		do
			...
			./fio --group_reporting --name=test --directory=/mnt/sd"$x" --size="$SIZE"GB --bs="$BS"KB --direct="$DIRECT" --fsync=0 --rw=randread --numjobs="$njobs" >> ./result_sd"$x"_buffered.txt 2>&1 & 
		done
		wait
	}
	let BS=$BS*2;
...
for ((iter1=0; iter1<1; iter1++)){
	for((iter2=0; iter2<=2; iter2++)){
		...
		do
			...
			./fio --group_reporting --name=test --directory=/mnt/sd"$x" --size="$SIZE"GB --bs="$BS"KB --direct="$DIRECT" --fsync=0 --rw=randwrite --numjobs="$njobs" >> ./result_sd"$x"_buffered.txt 2>&1 & 
		done
		wait
	}
	let BS=$BS*2;
